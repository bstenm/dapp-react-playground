...
import {getCandidateInfo, getTotalVotesFor, addCandidateInfo, addVoteFor} from './CandidatesContract';
...
describe('addCandidateInfo', () => {
      ...
      it('Adds a info item for a candidate', async () => {
            ...
            await addCandidateInfo({candidate, title: 'title', description: 'description', attachmentHash: 'filehash'});
...
describe('addVoteFor', () => {
      ...
      it('Adds a vote to a candidate tally', async () => {
            ...
            expect(addVoteForSpy.mock.calls.length).toEqual(1);
