export default {
      ...
      tooShort: min => `Should be at least ${min} characters long`,
     fileTooLarge: max => `This file is too large, max size allowed: ${ max } kb`,
     fIleTypeError: allowed => `Only  ${ allowed } allowed`,
};