...
describe( '(Container) CandidateInfoList', () => {
      ...
      it('Gets the candidate\'s info on mount', () => {
            ...
            expect(props.fetchInfo.mock.calls[0][0] ).toEqual('Khalifa Bin Zayed');;
      });
      ...
      it('Passes candidate data as prop to  component', () => {
            expect(wrapper.find(CandidateInfoList).props().candidate).toEqual('Khalifa Bin Zayed');
      });
      ...
      it('Passes the list of the candidate info returned by the selector as prop to  component', () => {
            ...
            expect(props.getInfoFor.mock.calls[0][0] ).toEqual('Khalifa Bin Zayed');;
